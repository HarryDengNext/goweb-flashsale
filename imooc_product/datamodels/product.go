...
type Product struct {
	...
	ProductPrice   string `json:"ProductPrice" sql:"productPrice" imooc:"ProductPrice"`
	ProductOriginPrice   string `json:"ProductOriginPrice" sql:"productOriginPrice" imooc:"ProductOriginPrice"`
